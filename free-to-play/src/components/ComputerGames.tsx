import { faDesktop, faGamepad, faSpinner } from "@fortawesome/free-solid-svg-icons";
...
const ComputerGames = () => {
  const { isLoading, games } = useGames("/games?platform=pc");
    ...
    <>
      {!isLoading ? (
        <>
         <div className="title">
            <h3>
              <FontAwesomeIcon icon={faDesktop} color="white" className="icon"/>
              PC Games
            </h3>
          </div>
          <hr />
